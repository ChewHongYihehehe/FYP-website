...
<head>
    ...
    <title>About Us - Step Online Shoes Shop</title>
    ...
    <main>
        <section class="about-section">
            <div class="container">
                ...
                <p>Thank you for choosing <strong>Step Online Shoes Shop</strong>. Your satisfaction is our top priority!</p>
            </div>
        </section>
    </main>
    <footer>
        <div class="container">
            <p>&copy; 2024 Step Online Shoes Shop. Designed with ❤️ by our team.</p>
        </div>
    </footer>
</body>
